...
urlpatterns = [
    ...
    path(
        ...
        views.create_trading_order_view,
        name="create_trading_order",
    ),
    path("trading/orders/", views.list_trading_orders_view, name="list_trading_orders"),
    path(
        "trading/orders/<int:order_id>/",
        views.trading_order_detail_view,
        name="trading_order_detail",
    ),
    path(
        "trading/transactions/create/",
        views.create_transaction_view,
        name="create_transaction",
    ),
    path(
        "trading/transactions/", views.list_transactions_view, name="list_transactions"
    ),
    path(
        "sales/orders/<int:order_id>/invoice/",
